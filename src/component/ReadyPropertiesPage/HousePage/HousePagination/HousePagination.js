...
import '../../ApartmentPage/ApartmentPagination/ApartmentPagination';
        ...
        <div>
            ...
            <nav aria-label="Page navigation example">
                <ul className="pagination">
                    ...
                    <li className="page-item "><NavLink exact className="page-link" activeClassName="pageactive" to={`${base_url}/house`}>1</NavLink></li> 
